...
#Region "Init"
    Friend Sub New(ByVal autoInstall As Boolean)
        If autoInstall Then
...
#Region "Methods"
    ...
    Friend Function InstallEvergreenWebViewer2() As Boolean
        Dim localFP As String = IO.Path.Combine(IO.Path.GetDirectoryName(Application.ExecutablePath), "WebView2Setup.exe")
